...
class InformationController extends Controller
{
    public function feeCategoryAmount()
    {
        ...
        return view('student.information.view-fee-category-amount', $data);
    }
    ...
    public function feeCategoryAmountDetails($fee_category_id)
    {
        ...
        return view('student.information.details-fee-category-amount', $data);
    }

    public function viewExamType()
    {
        $data['allData'] = ExamType::all();
        return view('student.information.view-exam-type', $data);
    }

    public function viewAssignSubject()
    {
        $data['allData'] = AssignSubject::select('class_id')->groupBy('class_id')->get();
        return view('student.information.view-assign-subject', $data);
    }

    public function detailsAssignSubject($class_id)
    {
        $data['detailsData'] = AssignSubject::where('class_id', $class_id)->get();
        return view('student.information.details-assign-subject', $data);
    }

    public function viewMarkGrade()
    {
        $data['allData'] = MarksGrade::all();
        return view('student.information.view-mark-grade', $data);
    }
    ...
    public function markSheetView()
    {
        ...
        return view('student.information.view-mark-sheet', $data);
    }
    ...
    public function markSheetGet(Request $request)
    {
        ...
        if ($singleStudent == true) {
            ...
            return view('student.information.pdf-mark-sheet', compact('allMarks', 'allGrades', 'count_fail'));
        } else {
