...
class MonthlyFeeController extends Controller
{
    ...
    public function getStudendt(Request $request)
    {
        ...
        foreach ($allStudent as $key => $v) {
            $monthlyfee = FeeCategoryAmount::where('fee_category_id', '4')->where('class_id', $v->class_id)->first();
            $color = 'success';
    ...
    public function PaySlip(Request $request)
    {
        ...
        $pdf = PDF::loadView('backend.student.monthly_fee.monthly-fee-slip-pdf', $data);
