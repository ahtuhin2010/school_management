            ...
            <div class="row">
                ...
                <section class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="GET" action="{{ route('student.reports.marksheet.get') }}" id="myForm" target="_blank">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" name="id_no" value="{{ Auth::user()->id_no }}" readonly class="form-control form-control-sm">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <button id="search" class="btn btn-primary btn-sm" name="search">Search</button>
                                    </div>
                                </div>
                            </form>
