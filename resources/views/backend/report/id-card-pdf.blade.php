                        ...
                        <tbody>
                            <tr>
                                ...
                                <td width="40%" class="text-center">
                                    ...
                                    <p class="btn btn-primary" style="padding: 5px; font-size: 20px">
                                        Student ID Card
                                    </p>
                                </td>
                            ...
                            <tr>
                                <td width="40%" style="padding: 10px 3px 10px 5px">
                                    <p style="font-size: 16px"><strong>Session : </strong>{{ $data['year']['name'] }}</p>
                                </td>
                                <td width="20%" style="padding: 10px 3px 10px 5px">
                                    <p style="font-size: 16px"><strong>Class : </strong>{{ $data['student_class']['name'] }}</p>
                                </td>
                                <td width="40%" style="padding: 10px 3px 10px 5px">
                            ...
                            <tr>
                                <td width="50%" style="padding: 10px 3px 10px 5px">
                                    <p style="font-size: 16px"><strong>Mobile No : </strong>{{ $data['student']['mobile_no'] }}</p>
                                </td>
                                <td></td>
                                <td></td>
                            </tr>
