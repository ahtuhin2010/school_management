            ...
            <div class="row">
                ...
                <section class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('notice.update', $editData->id)}}" id="myForm">
                                @csrf

                                <div class="form row">
                                    <div class="form-group col-md-6">
                                        <label for="subject">Notice Subject</label>
                                        <input type="text" name="subject" value="{{ $editData->subject }}" class="form-control" placeholder="Write Notice Subject">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="textarea" name="description" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{!! $editData->description !!}</textarea>
