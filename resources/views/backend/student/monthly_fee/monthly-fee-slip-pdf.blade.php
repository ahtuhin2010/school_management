...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                @php
                    $monthly = App\Model\FeeCategoryAmount::where('fee_category_id', '4')->where('class_id', $details->class_id)->first();
                    $orginalfee = $monthly->amount;
                ...
                <table border="1" width="100%">
                    <tbody>
                        ...
                        <tr>
                            <td style="50%">Fee (This Student) of {{$month}}</td>
                            <td>{{ $finalfee }} Tk</td>
                        </tr>
