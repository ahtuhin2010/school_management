...
@section('content')
<link rel="stylesheet" type="text/css" href="{{ asset('backend/css/attend/attend.css') }}">
<style type="text/css">
    .switch-toggle {
        width: auto;
    }
    ...
    .switch-candy a {
        ...
        border-radius: 3px;
        box-shadow: 0 1px 1px rgba(0, 0, 0, 0.2), inset 0 1px 1px grba(255, 255, 255, 0.45);
    ...
    .switch-toggle.switch-candy, .switch-light.switch-candy > span {
        ...
        border-radius: 3px;
        box-shadow: 0 2px 6px rgba(0, 0, 0, 0.3), 0 1px 0px grba(255, 255, 255, 0.2);
    }
</style>
                            ...
                            <table class="table-sm table-bordered table-striped dt-responsive" style="width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2" class="text-center" style="vertical-align: middle;">Employee ID No</th>
                                    ...
                                    <tr>
                                        <th class="text-center btn present_all" style="display: table-cell; background-color: #114190; color: #fff;">Present</th>
                                        <th class="text-center btn leave_all" style="display: table-cell; background-color: #114190; color: #fff">Leave</th>
                                        <th class="text-center btn absent_all" style="display: table-cell; background-color: #114190; color: #fff">Abesent</th>
                                    </tr>
                                </thead>
                                <tbody>
