            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('parent.home') }}">Home</a></li>
                        <li class="breadcrumb-item active"></li> Marksheet</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div style="border: solid 2px; padding: 7px">
                                        ...
                                        <table border="1" width="100%" cellpadding="1" cellspacing="1" class="text-center">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $mark->start_mark }} - {{ $mark->end_marks }}</td>
                                                    <td>
                                        ...
                                        <table border="1" width="100%" cellpadding="1" cellspacing="1" class="text-center">
                                            ...
                                            <tbody>
                                                @php
                                                    ...
                                                    $total_grade = App\Model\MarksGrade::where([['start_point', '<=', (int)$point_for_letter_grade],['end_point', '>=', (int)$point_for_letter_grade]])->first();
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <table border="1" width="100%" cellpadding="10" cellspacing="2" class="text-center">
                                            <tbody>
                                                <tr>
